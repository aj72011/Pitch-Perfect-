  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground font-semibold shadow-glow hover:shadow-[0_0_50px_-10px_hsl(217_91%_60%_/_0.5)] hover:scale-[1.02] active:scale-[0.98]",
        "hero-outline": "border border-primary/30 bg-primary/5 text-foreground hover:bg-primary/10 hover:border-primary/50",
        accent: "bg-accent text-accent-foreground font-semibold shadow-glow-accent hover:brightness-110",
        glass: "glass text-foreground hover:bg-secondary/40",
      },
      size: {
